  ...
  from (
    values
      ...
      ('Oltapp Verified','Şile Limanı',
        ...
        94,'OSM Nominatim verified batch4 v1'),
      ...
      ('Oltapp Verified','Büyükçekmece Kıyı Hattı',
        ...
        90,'OSM Nominatim verified batch4 v1'),
      ...
      ('Oltapp Verified','Tekirdağ Süleymanpaşa Kıyı Hattı',
        ...
        89,'OSM Nominatim verified batch4 v1'),
      ...
      ('Oltapp Verified','Karaburun İzmir Kıyı Hattı',
        ...
        92,'OSM Nominatim verified batch4 v1'),
      ...
      ('Oltapp Verified','Foça Kıyı Hattı',
        ...
        91,'OSM Nominatim verified batch4 v1'),
      ...
      ('Oltapp Verified','Yalıkavak Marina',
        ...
        93,'OSM Nominatim verified batch4 v1'),
      ...
      ('Oltapp Verified','Erdemli Kıyı Hattı',
        ...
        88,'OSM Nominatim verified batch4 v1'),
...
-- where source_note = 'OSM Nominatim verified batch4 v1';
