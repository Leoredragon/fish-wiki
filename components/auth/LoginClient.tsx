    ...
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <button
          type="button"
          disabled
          className="w-full flex items-center justify-center space-x-2 py-3.5 px-4 border border-slate-200 rounded-2xl text-slate-400 bg-slate-100/80 font-bold transition-all shadow-none cursor-not-allowed opacity-75"
        >
          <svg className="w-5 h-5 grayscale opacity-60" viewBox="0 0 24 24">
            <path
          ...
          <span>{isTr ? 'Google ile Devam Et (Yakında)' : 'Continue with Google (Coming Soon)'}</span>
        </button>
