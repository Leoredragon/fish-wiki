      ...
      {isVisible && (
        ...
        >
          ...
          <div className="relative flex items-center justify-center mb-6">
            ...
            {/* Inner Emerald Badge & Spinning Fish */}
            <div className="absolute w-20 h-20 rounded-2xl bg-gradient-to-br from-emerald-400 via-emerald-500 to-teal-700 flex items-center justify-center shadow-2xl shadow-emerald-500/30 border border-emerald-300/30">
              <motion.div
              ...
              >
                <Fish className="w-10 h-10 text-[#0F172A] drop-shadow-md" />
              </motion.div>
            </div>
          </div>
          ...
          >
            <h1 className="text-3xl font-extrabold tracking-wider text-white flex items-center justify-center space-x-2">
              <span>OltaApp</span>
          ...
          <motion.div
            ...
            className="absolute bottom-8 text-[11px] text-slate-400 tracking-wider font-medium flex items-center space-x-1"
          >
